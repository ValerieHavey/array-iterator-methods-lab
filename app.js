...
let sortedByBirthYear = inventors.sort((firstItem) => {
    return firstItem.year;
});
...
//I know this only works for the current year because I did the math on 
//current year minus 18 or whatever so lemme know what the correct way to do this is
// so it's true every year without changing the code. Thanks!
